...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.printf(new Locale("pt","BR"), "EP1 Salario Fixo: %.2f - Salario Total: %.2f - Valor Bonus: %.2f\n",
        ...
        System.out.printf(new Locale("pt","BR"),"EP2 Salario Fixo: %.2f - Salario Total: %.2f - Valor Bonus: %.2f\n",
        ...
        System.out.printf(new Locale("pt","BR"),"GR1 Salario Fixo: %.2f - Salario Total: %.2f - Valor Bonus: %.2f\n",
